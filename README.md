...
unsigned long myChannelNumber = 2794363;
const int ChannelField = 1; 
const char * myWriteAPIKey = "JNEX15IUVCITQ7VE";
...
```
# CIRCUIT DIAGRAM:
![image](https://github.com/user-attachments/assets/1dba8576-7c9d-4869-9e4b-977244ef7a62)

# OUTPUT:
![image](https://github.com/user-attachments/assets/39cfd28b-4479-4375-9591-5eb23193cecc)
![image](https://github.com/user-attachments/assets/fa635dc7-991e-4986-90e9-afc456e0fd12)
